...
.my-2{
background-color: white; /* White background */
  border: 1px solid rgb(181, 124, 9); /* Blue border */
  color:rgb(220, 151, 11); /* Blue text */
  padding: 10px 20px; /* Padding for better spacing */
  margin: 5px; /* Margin between buttons */
  cursor: pointer; /* Pointer cursor on hover */
  border-radius: 5px; /* Rounded corners */
...
.my-2:hover {
  background-color:rgb(220, 151, 11); /* Blue background on hover */
  color: white; /* White text on hover */
}
   ...
   <section class="container-fluid p-0">
    ...
    <div class="scroll-container">
      <div class="scroll-content">
        ...
        <!-- Product 1 -->
        <div class="product">
          <img src="https://via.placeholder.com/150" alt="Samsung Galaxy 10">
        ...
        <!-- Product 2 -->
        <div class="product">
          <img src="https://via.placeholder.com/150" alt="Readme Note 7">
          <h6>Readme Note 7</h6>
          <div class="rating">
            <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="far fa-star"></i>
          </div>
        ...
        <!-- Product 4 -->
        <div class="product">
          <img src="https://via.placeholder.com/150" alt="OnePlus 9">
          <h6>OnePlus 9</h6>
          <div class="rating">
            <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="far fa-star"></i>
          </div>
        ...
        <!-- Product 5 -->
        <div class="product">
          <img src="https://via.placeholder.com/150" alt="Google Pixel 6">
          <h6>Google Pixel 6</h6>
          <div class="rating">
            <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="far fa-star"></i>
          </div>
        ...
        <!-- Product 6 -->
        <div class="product">
          <img src="https://via.placeholder.com/150" alt="Sony Xperia">
          <h6>Sony Xperia</h6>
          <div class="rating">
            <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="far fa-star"></i>
          </div>
